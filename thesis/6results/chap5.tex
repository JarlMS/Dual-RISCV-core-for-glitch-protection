...
From the tables we see that the total power consumption is increased by $189.33\%$. Leakage power increases by $129.39\%$, internal power increases by $286.61\%$ and switching power increases by $109.58\%$. 

\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{docs/images/power_comparison_pie.png}
    \caption{Comparison of percentage used of total power for each cateogory in both cores.}
