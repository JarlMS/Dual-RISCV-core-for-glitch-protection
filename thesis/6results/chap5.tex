...
Area reports after synthesis of both cores are shown in \autoref{tab:cv32e40dc_area} and \autoref{tab:cv32e40s_area}. 
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{docs/images/area_comparison.png.png}
